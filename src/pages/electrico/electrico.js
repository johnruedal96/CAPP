...
var ElectricoPage = (function () {
    function ElectricoPage(navCtrl, navParams, ws) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.ws = ws;
    }
    ElectricoPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ElectricoPage');
    };
...
ElectricoPage = __decorate([
    ...
    __metadata("design:paramtypes", [NavController, NavParams, WebServiceProvider])
], ElectricoPage);
